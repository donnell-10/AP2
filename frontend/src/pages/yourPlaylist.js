...
import { updatePlaylist } from "../actions/userData";
import './styles.css'

const YourPlaylist = ({updatePlaylist}) => {
    ...
    const handleSubmit =() => {
      ...
      updatePlaylist(playlistid, trackids, numberOfSongs)
...
export default connect(null, {updatePlaylist})(YourPlaylist);